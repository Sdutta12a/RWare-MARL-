...
# class LinearDeepQNetwork(nn.Modeule):
#     def __init__(self, lr, n_actions, input_dims):
#         super(LinearDeepQNetwork,self).__int__()
...
#         else:
#             action = np.random.choice(self.action_sapce)
...
#         print('episode',i,'score %.lf avg score %.if epsilon %.2f' %
